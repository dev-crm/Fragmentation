...
class DebugHierarchyViewContainer : ScrollView {
    ...
    private fun initView(context: Context) {
        ...
        mTitleLayout.setOnClickListener {
            Toast.makeText(
                mContext,
                R.string.fragmentation_stack_help,
                Toast.LENGTH_LONG
            ).show()
        }
    ...
    fun bindFragmentRecords(fragmentRecords: List<DebugFragmentRecord>?) {
        ...
        mLinearLayout.addView(mTitleLayout)
    ...
    private fun setView(
        ...
        for (i in fragmentRecordList.indices.reversed()) {
            ...
            val childTvItem: TextView = getTextView(child, tempHierarchy)
    ...
    private fun getTextView(fragmentRecord: DebugFragmentRecord, hierarchy: Int): TextView {
        ...
        val a =
            mContext!!.obtainStyledAttributes(intArrayOf(android.R.attr.selectableItemBackground))
